...
import { Camera, CreditCard, MapPin, ShoppingBag, X, Upload, Check } from "lucide-react";
...
const ProfileContent: React.FC<IProfileContentProps> = ({ user }) => {
    ...
    const handleProfileImageChange = (files: File[]) => {
        ...
        console.log('Profile image data:', files);
    };

    const handleSaveProfileImage = () => {
        console.log('Saving profile image:', profileImage);
        // I'll upload the image to apprwrite over here
        handleCloseModal();
    };
        ...
        <div className="flex">
            ...
            {showUploader && (
                ...
                `}>
                    ...
                    {/* Modal */}
                    <div className={`
                        relative bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[90vh] 
                    ...
                    `}>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-blue-100 text-sm">Choose a new image for your profile</p>
                                    </div>
                                </div>
                                <button 
                                    onClick={handleCloseModal}
                                    className="w-8 h-8 bg-white bg-opacity-20 cursor-pointer rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-200"
                                >
                                    <X size={18} />
                                </button>
                            </div>
                        ...
                        <div className="p-6">
                            <div className="h-96">
                                <FileUploader 
                                    fieldChange={handleProfileImageChange}
                        ...
                        <div className="bg-gray-50 px-6 py-4 flex items-center justify-between border-t border-gray-200">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                />
                                <Button 
                                    text={profileImage.length > 0 ? "Save Image" : "Choose Image"}
                                    ...
                                    `}
                                    disabled={profileImage.length === 0}
                                />
                            </div>
                        </div>
                    </div>
